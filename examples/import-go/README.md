...
export functions using [HostModuleBuilder](https://pkg.go.dev/github.com/youshandefeiyang/wazero#HostModuleBuilder) and how a
...
[wasi package](https://pkg.go.dev/github.com/youshandefeiyang/wazero/wasi).
